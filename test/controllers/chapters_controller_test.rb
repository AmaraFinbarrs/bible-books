...
class ChaptersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post chapters_url, params: { chapter: { book_id: @chapter.book_id, chapter_no: @chapter.chapter_no } }
    end
  ...
  test "should update chapter" do
    patch chapter_url(@chapter), params: { chapter: { book_id: @chapter.book_id, chapter_no: @chapter.chapter_no } }
